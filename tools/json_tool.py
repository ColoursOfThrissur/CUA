...
class JSONTool(BaseTool):
    ...
    def register_capabilities(self):
        ...
        parse_cap = ToolCapability(
            name="parse",
            description="Parse JSON string",
            parameters=[
                Parameter("text", ParameterType.STRING, "JSON string to parse")
            ],
        ...
        stringify_cap = ToolCapability(
            name="stringify",
            description="Convert object to JSON string",
            parameters=[
                Parameter("data", ParameterType.DICT, "Data to stringify")
            ],
            returns="JSON string",
            safety_level=SafetyLevel.LOW,
        ...
        query_cap = ToolCapability(
            name="query",
            description="Query JSON data by path",
            parameters=[
                Parameter("data", ParameterType.DICT, "JSON data"),
                Parameter("path", ParameterType.STRING, "Dot-separated path")
            ],
