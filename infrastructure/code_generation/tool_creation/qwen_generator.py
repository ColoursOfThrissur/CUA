        ...
        for attempt in range(2):
            ...
            for name in handler_names:
                ...
                if handler_code:
                    ...
                    from infrastructure.code_generation.tool_creation.base import check_handler_service_calls, check_handler_missing_return
...
- NO imports, NO class definition"""
    ...
    def _build_contract_pack(self, skill_category: str = None) -> str:
        ...
        from infrastructure.code_generation.tool_creation.base import TOOL_CREATION_RULES
        SKILL_SERVICES = {
