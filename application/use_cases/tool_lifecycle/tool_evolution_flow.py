...
from infrastructure.failure_handling.evolution_failure_classifier import EvolutionFailureClassifier, OVERFLOW_SIZE_BYTES
...
class ToolEvolutionOrchestrator:
    ...
    def _evolve_tool_inner(
        ...
        from application.use_cases.evolution.tool_analyzer import ToolAnalyzer
        ...
        for attempt in range(3):  # Increased from 2 to allow validation feedback retry
            try:
                ...
                from infrastructure.validation.ast.tool_evolution_validator import EvolutionValidator
                ...
                # Sandbox test
                from infrastructure.sandbox.evolution_sandbox_runner import EvolutionSandboxRunner
...
- Follow all constraints listed above"""
    ...
    def _select_generator(self):
        ...
        from infrastructure.code_generation.tool_evolution_generator import EvolutionCodeGenerator
