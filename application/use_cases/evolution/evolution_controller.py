...
from domain.value_objects.proposal_types import EvolutionProposal, ProposalType
from domain.services.capability_graph import CapabilityGraph
from domain.policies.growth_budget import GrowthBudget
from application.use_cases.improvement.self_reflector import SelfReflector
from application.services.expansion_mode import ExpansionMode
from domain.policies.refactoring_permissions import RefactoringPermissions
from domain.services.risk_weighted_decision import RiskWeightedDecision
...
from infrastructure.failure_handling.failure_classifier import FailureClassifier
from domain.policies.interface_protector import InterfaceProtector
...
"""
        ...
        try:
            ...
            # AST validation
            from infrastructure.validation.ast.ast_validator import ASTValidator
