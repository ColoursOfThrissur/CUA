    ...
    def approve_evolution(self, tool_name: str) -> bool:
        ...
        if evolution_id:
            try:
                ...
                from infrastructure.persistence.sqlite.cua_database import get_conn as _get_conn
                report = ToolQualityAnalyzer(get_execution_logger()).analyze_tool(tool_name)
