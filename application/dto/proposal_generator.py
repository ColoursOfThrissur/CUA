...
class ProposalGenerator:
    def __init__(self, llm_client, system_analyzer, patch_generator, update_orchestrator):
        ...
        from infrastructure.code_generation.orchestrated_generator import OrchestratedCodeGenerator
        self.code_generator = OrchestratedCodeGenerator(llm_client, system_analyzer)
        
        # Create step planner
        from application.use_cases.planning.step_planner import StepPlanner
    ...
    def generate_proposal(self, analysis: Dict) -> Optional[Dict]:
        ...
        from infrastructure.code_generation.code_critic import CodeCritic
        critic = CodeCritic()
        ...
        from infrastructure.validation.behavior_validator import BehaviorValidator
    ...
    def _generate_incremental_proposal(self, analysis: Dict) -> Optional[Dict]:
        ...
        """
        from infrastructure.logging.logging_system import get_logger
        from infrastructure.code_generation.incremental_builder import IncrementalCodeBuilder
        logger = get_logger("proposal_generator")
